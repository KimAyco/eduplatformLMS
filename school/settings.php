...
<div class="panel">
    ...
    <div class="school-settings-preview">
        <div class="school-settings-preview-card">
            <div class="school-card-cover" style="background-image: url('<?= e($coverPreviewUrl) ?>')"></div>
    ...
    <form method="post" enctype="multipart/form-data" class="school-settings-form">
        <?= csrfField() ?>
        <input type="hidden" name="action" value="upload_cover">
        <div class="form-group">
            <label for="cover">Upload new cover photo</label>
            <input type="file" id="cover" name="cover" class="form-control" accept="image/jpeg,image/png,image/webp,image/gif" required>
...
<div class="panel">
    ...
    <div class="school-settings-preview school-settings-preview--logo">
        <?= schoolAvatarHtml($school, 'school-avatar') ?>
    ...
    <form method="post" enctype="multipart/form-data" class="school-settings-form">
        ...
        <div class="form-group">
            ...
            <input type="file" id="logo" name="logo" class="form-control" accept="image/jpeg,image/png,image/webp,image/gif" required>
